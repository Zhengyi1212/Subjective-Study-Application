    ...
    <el-main class="main">
        ...
        <el-tabs class="tabs" type="border-card" :tab-position="tabPosition">
          <el-tab-pane label="Rate">
            <div class="block">
              ...
              <el-button class="save-button" type="primary" round >Save</el-button>
            </div>
          </el-tab-pane>
      ...
      <div class="buttons-pagination-container">
        ...
        <div>
          ...
          <el-button type="primary" round @click="goToResultPage">Go to see progress</el-button>
        </div>
...
export default {
  created() {
    ...
    // cjs here we load pre-defined images for each
